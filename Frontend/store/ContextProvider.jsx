...
const ContextProvider=({children})=>{
    ...
    const getAllBlogs=async()=>{
        const fetchedData=await fetch('https://blogify-frontend-90q1.onrender.com/blog/getAllBlogs',{
    ...
    const getCategoryBlogs=async(category)=>{
        const fetchedData=await fetch(`https://blogify-frontend-90q1.onrender.com/blog/getAllBlogs/${category}`,{
            headers:{'Content-Type':'application/json'},
            credentials:'include',
        })
    ...
    const validUser=async()=>{
        ...
        const fetchedData=await fetch('https://blogify-frontend-90q1.onrender.com/user/profile',{
            method:'GET',
            headers:{'Content-Type':'application/json'},
            credentials:'include',
        })
    ...
    const handleUserDetail=async()=>{
        const fetchedData=await fetch('https://blogify-frontend-90q1.onrender.com/user/getUser',{
            method:'GET',
            headers:{'Content-Type':'application/json'},
            credentials:'include',
        })
