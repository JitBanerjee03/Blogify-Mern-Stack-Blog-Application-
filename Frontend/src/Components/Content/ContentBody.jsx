...
const ContentBody=({blogItem,handleSingleBlogPost,setBlogContent})=>{
    ...
    const handleUpvote=async(blogItem)=>{
        const fetchedData=await fetch('https://blogify-backend-gyue.onrender.com/blog/upVoteBlog',{
            method:'PUT',
            headers:{'Content-Type':'application/json'},
            credentials:'include',
            body:JSON.stringify({
    ...
    const handleDownvote=async(blogItem)=>{
        const fetchedData=await fetch('https://blogify-backend-gyue.onrender.com/blog/downVoteBlog',{
            method:'PUT',
            headers:{'Content-Type':'application/json'},
            credentials:'include',
            body:JSON.stringify({
